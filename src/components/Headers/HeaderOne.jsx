...
=============================================*/
    ...
    // Replace mobile menu content with anchor links
    if ($(".mobile-menu").length) {
      var mobileMenuContent = `
        <ul class="navigation">
          ...
          <li><a href="#testimonial" class="mobile-menu-link">Testimonials</a></li>
          <li><a href="#contact" class="mobile-menu-link">Contact</a></li>
        </ul>
      `;
      $(".mobile-menu .menu-box .menu-outer").html(mobileMenuContent);

      // Add click event to mobile menu links to close menu when clicked
                ...
                <div className="mobile-menu">
                  <nav className="menu-box">
                    ...
                    <div className="menu-outer">
                      {/* Mobile menu items will be added via JavaScript */}
                    </div>
              ...
              <div className="row">
                        ...
                        <div className="contact-info-list">
                          <ul className="list-wrap">
                            ...
                            <li>
                              ...
                              <div className="content">
                                <span>
                                  200 5th Street NW, Suite J, Elk River, MN 55330
                                </span>
                              </div>
                            </li>
                            <li>
                ...
                <div className="col-lg-4">
                  <div className="customer-support-wrap">
                    <h4 className="title">Marketing Services</h4>
                    <div className="customer-support-content">
                      <div className="content-top">
                        <img src="/img/images/support_img.png" alt="" />
                        <h4 className="title">Need Help With Your Marketing?</h4>
                      </div>
                      <p>
